class LLMAgent {
    ...
    clearChat() {
        ...
        this.addMessage('agent', 'Welcome back to LLMAgent! 🧠 I\'m ready to assist you with intelligent searches, AI workflows, and code execution. What can I help you accomplish?');
